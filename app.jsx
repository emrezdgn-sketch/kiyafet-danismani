...
async function runAnalysis(safeImage, occasion) {
  ...
  if (occasion) {
    // Bağlam metni, cache_control ile işaretli sabit system talimatının
    // DIŞINDA, her istekte değişen user mesajına ekleniyor — böylece system
    // prompt'un önbellek isabeti (bkz. aşağıdaki yorum) bozulmuyor.
    content.push({ type: 'text', text: occasion.hint });
  }
